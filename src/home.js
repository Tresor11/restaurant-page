...
function home() {
  ...
  method.updateText(intro, "Food isn't meant to just be eaten it should be enjoyed");
  ...
  method.updateText(footer, 'karibu restaurant is a space where you get quality food');
  method.updateText(header, 'Karibu restaurant');
